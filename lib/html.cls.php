...
EOF;
...

    {
    		...
    		<div class="qq-uploader-selector" qq-drop-area-text="可将图片拖拽至此处上传" style="clear:both;">
            	...
            	<ul class="qq-upload-list-selector list-unstyled pull-left" aria-live="polite" aria-relevant="additions removals" style="clear:both;">
	                ...
	                <li class="text-center">
						...
						<input size="45" placeholder="可以上传的文件格式:$uptypes" class="form-control qq-edit-filename-selector" type="text" name="$name" tabindex="0" value="">
	            ...
	            <ul class="qq-upload-list-selector list-unstyled pull-left" aria-live="polite" aria-relevant="additions removals" style="clear:both;">
	                ...
	                <li class="text-center">
	                    ...
	                    <input size="45" placeholder="可以上传的文件格式:$uptypes" class="form-control qq-edit-filename-selector" type="text" name="$name" tabindex="0" value="$v">
        ...
        <div class="fineuploader" attr-type="files" attr-template="pe-template-$id" attr-ftype="$uptypes"></div>
