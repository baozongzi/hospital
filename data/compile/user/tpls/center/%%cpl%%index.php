			...
			<div class="col-xs-10" id="datacontent">
				...
				<div class="box itembox" style="padding-top:10px;">
					...
					<table width="100%">
						<tr>
							<td width="30%">
								<div class="thumbnail" style="width:80%;height: 160px;">
								<?php if($this->tpl_var['_user']['photo']){ ?>
									<img style="max-width:100%;height: 100%; "  src="<?php echo $this->tpl_var['_user']['photo']; ?>" />
								<?php } else { ?>
									<span style="font-weight: 700;font-size: 20px;text-align: center;line-height: 160px;display: block;">快去上传图片吧</span>
								<?php } ?>
								</div>
							</td>
