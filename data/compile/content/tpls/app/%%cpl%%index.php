...
<div class="container-fluid">
	<div class="row-fluid">
		<div class="main box itembox" style="height:450px;overflow:hidden;">
			<h4 class="title">课程分类</h4>
			<div class="col-xs-2 box itembox" style="width:25%;height:450px;overflow:hidden;">
				<?php $cid = 0;
 ...
 $cid++; ?>
						...
						<?php if($content['is_link'] == 1){ ?>
							<a href="index.php?content-app-content&contentid=<?php echo $content['contentid']; ?>">
						<?php } ?>
								<img src="<?php echo $content['contentthumb']; ?>" alt="" style="width:100%;height: 360px;">
						<?php if($content['is_link'] == 1){ ?>
							</a>
						<?php } ?>
 ...
 $cid++; ?>
				<div class="col-xs-4">
					<a href="index.php?course-app-course&csid=<?php echo $course['csid']; ?>" class="thumbnail">
						<img src="<?php echo $course['csthumb']; ?>" alt="" width="180" style="height:130px;">
					</a>
 ...
 $bid++; ?>
				<div class="col-xs-3">
					<a href="index.php?exam-app-index-setCurrentBasic&basicid=<?php echo $basic['basicid']; ?>" class="thumbnail ajax">
						<img src="<?php echo $basic['basicthumb']; ?>" alt="" width="180" style="height: 140px;">
					</a>
