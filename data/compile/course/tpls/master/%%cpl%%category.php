...
<?php } ?>
 ...
 $cid++; ?>
									<tr>
										...
										<td style="width: 360px;"><a onclick="javascript:openmenu(this);" href="javascript:void(0);" class="icon-plus-sign catool" rel="<?php echo $category['catid']; ?>" data="0" app="<?php echo $this->tpl_var['_app']; ?>"></a><span><?php echo $category['catname']; ?></span></td>
										<td>
											<div class="btn-group">
											<a class="btn" href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-category&parent=<?php echo $category['catid']; ?>"><em class="glyphicon glyphicon-th-list"></em></a>
												...
												<a class="btn" href="javascript:if(confirm('确实要删除吗?'))location='index.php?<?php echo $this->tpl_var['_app']; ?>-master-category-del&catid=<?php echo $category['catid']; ?>&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>'"><em class="glyphicon glyphicon-remove"></em></a>
											</div>
										</td>
									</tr>
									<?php } ?>
