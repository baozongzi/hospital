...
<?php } ?>
 ...
 $cid++; ?>
					            	<tr>
					                    ...
					                    <td class="picture" style="line-height: 60px;"><img src="<?php if($course['csthumb']){ ?><?php echo $course['csthumb']; ?><?php } else { ?>app/core/styles/images/noupload.gif<?php } ?>" alt="" style="width:60px;"/></td>
					                    <td>
