				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					...
					<form action="index.php?course-master-course-lite" method="post" class="form-horizontal">
						<div class="form-group">
				            ...
				            <div class="col-sm-6">
			        			<input class="form-control" type="text" name="courseids" value="<?php echo $this->tpl_var['courseids']; ?>" needle="needle" msg="您必须输入标题" readonly>
				        	</div>
				        </div>
				        <div class="form-group">
 ...
 $cid++; ?>
				        ...
				        <div class="form-group">
				            ...
				            <div class="col-sm-9">
					            ...
					            <a class="btn btn-primary" href="index.php?course-master-course&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>">取消</a>
					            <?php $sid = 0;
