...
<?php } ?>
 ...
 $sid++; ?>
				        ...
				        <!-- <div class="form-group">
				            ...
				            <div class="col-sm-9">
							    <textarea id="contentdescribe" name="args[csdescribe]" class="form-control" rows="4"><?php echo html_entity_decode($this->ev->stripSlashes(nl2br($this->tpl_var['course']['csdescribe']))); ?></textarea>
					        </div>
				        </div> -->
				        <div class="form-group">
				            <label for="coursetext" class="control-label col-sm-2">简介：</label>
				            <div class="col-sm-9">
							    <textarea id="coursetext" rows="7" cols="4" class="ckeditor" name="args[csdescribe]"><?php echo html_entity_decode($this->ev->stripSlashes($this->tpl_var['course']['csdescribe'])); ?></textarea>
					        </div>
				        </div>
				       <!--  <div class="form-group">
