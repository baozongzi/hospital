 ...
 $cid++; ?>
			<div class="box itembox" style="padding-top:20px;">
				...
				<div class="col-xs-9">
					...
					<p><a href="index.php?course-app-course&csid=<?php echo $content['csid']; ?>"><?php echo nl2br($content['csdescribe']);?></a></p>
					<hr/>
					<p>
						<span class="pull-right">
							<a href="index.php?course-app-course&csid=<?php echo $content['csid']; ?>"><span class="glyphicon glyphicon-time"></span> <span><?php echo date('Y-m-d H:i:s',$content['cstime']); ?></span></a>&nbsp;&nbsp;
							<a href="index.php?course-app-course&csid=<?php echo $content['csid']; ?>"><span class="glyphicon glyphicon-heart"></span> <span><?php echo $content['click']; ?></span></a>
						</span>
					</p>
				</div>
			</div>
