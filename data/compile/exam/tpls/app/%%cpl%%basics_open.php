...
<div class="container-fluid" id="datacontent">
 ...
 $bid++; ?>
				<div class="col-xs-3" style="width:20%">
					...
					<?php if($basic['basicdemo'] == 1){ ?>
					<a href="index.php?exam-app-index-setCurrentBasic&basicid=<?php echo $basic['basicid']; ?>" target="_self" class="thumbnail ajax" style="position:relative;">
					...
					<?php } ?>
						...
						<?php } ?>
						<img src="<?php if($basic['basicthumb']){ ?><?php echo $basic['basicthumb']; ?><?php } else { ?>app/core/styles/img/item.jpg<?php } ?>" alt="" width="100%" style="height: 140px;">
					</a>
