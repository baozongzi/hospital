			...
			<div class="box itembox">
				<div class="col-xs-12">
					<ol class="breadcrumb">
					  ...
					  <li class="active">试题解析&nbsp/&nbsp<?php echo $this->tpl_var['sessionvars']['examsession']; ?></li>
					</ol>
				</div>
			</div>
		</div>
...
<div class="container-fluid" id="questioncontent">
 ...
 $did++; ?>
			...
			<div class="col-xs-9 split pull-right" style="padding:0px;position:relative;">
				...
				<div class="box itembox">
					<h2 class="text-center tt" style="text-align: left;"><?php echo $this->tpl_var['sessionvars']['examsession']; ?></h2>
				</div>
				<?php $oid = 0; ?>
				<?php $qid = 0;
 foreach($this->tpl_var['questype'] as $key => $quest){ 
