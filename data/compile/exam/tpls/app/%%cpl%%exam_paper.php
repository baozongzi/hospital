...
<div class="container-fluid" id="questioncontent">
 ...
 $qid++; ?>
						...
						<?php } ?>
						<?php $oid++; ?>
						<li role="presentation" class="tabss presentation_<?php echo $quest; ?> <?php if($qid == 1){ ?> active <?php } ?>"><a href="#qt_<?php echo $quest; ?>" aria-controls="home" role="tab" data-toggle="tab"><?php echo $this->tpl_var['ols'][$oid]; ?></a></li>
						<?php } ?>
						<?php } ?>
						<?php } ?>
					</ul>
...
{
	var ind = $(".paperexamcontent").eq(index).attr('rel');
	$(".questionpanel").hide();
	$(".paperexamcontent").hide();
	$(".paperexamcontent").eq(index).show();
	$("#questype_"+ind).show();
	$('.tableindex').removeClass('active');
	$('.tabss').removeClass('active');
	$('.presentation_'+ind).addClass('active');
	$('#qt_'+ind).addClass('active');
	console.log($(".paperexamcontent").eq(index).attr('rel'));
}
