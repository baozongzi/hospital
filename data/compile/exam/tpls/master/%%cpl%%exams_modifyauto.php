 ...
 $qid++; ?>
							<div class="form-group questpanel panel_<?php echo $questype['questid']; ?>">
								...
								<div class="col-sm-9 form-inline">
									...
									<span class="info">&nbsp;分，描述&nbsp;</span><input class="form-control" type="text" name="args[examsetting][questype][<?php echo $key; ?>][describe]" value="<?php echo $this->tpl_var['exam']['examsetting']['questype'][$key]['describe']; ?>" size="10"/>
								</div>
							</div>
							<div class="form-group questpanel panel_<?php echo $questype['questid']; ?>">
