...
<?php } ?>
				<div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
					<div class="col-xs-12">
						<ol class="breadcrumb">
							...
							<li><a href="index.php?exam-master-rowsquestions-rowsdetail&questionid=<?php echo $this->tpl_var['questionparent']; ?>&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>">子试题列表</a></li>
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					<h4 class="title" style="padding:10px;">
						修改子试题
						<a class="btn btn-primary pull-right" href="index.php?exam-master-rowsquestions-rowsdetail&questionid=<?php echo $this->tpl_var['questionparent']; ?>&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>">子试题列表</a>
					</h4>
 ...
 $qid++; ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								...
								<div id="answerbox_5" class="answerbox"<?php if($this->tpl_var['questypes'][$this->tpl_var['question']['questiontype']]['questchoice'] != 5 || $this->tpl_var['questypes'][$this->tpl_var['question']['questiontype']]['questsort']){ ?> style="display:none;"<?php } ?>>
