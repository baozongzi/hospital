			...
			<div class="col-xs-10 box split" style="padding:0px;width:75%;">
				<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner" role="listbox">
						...
						{x2;if:v:content['is_link'] == 1}
							<a href="index.php?content-app-content&contentid={x2;v:content['contentid']}">
						{x2;endif}
								<img src="{x2;v:content['contentthumb']}" alt="" style="width:100%;height: 360px;">
						{x2;if:v:content['is_link'] == 1}
							</a>
						{x2;endif}
			...
			<div class="col-xs-9" style="padding-left:0px;">
				...
				<div class="col-xs-4">
					<a href="index.php?course-app-course&csid={x2;v:course['csid']}" class="thumbnail">
						<img src="{x2;v:course['csthumb']}" alt="" width="180" style="height:130px;">
					</a>
			...
			<div class="col-xs-9" style="padding-left:0px;">
				...
				<div class="col-xs-3">
					<a href="index.php?exam-app-index-setCurrentBasic&basicid={x2;v:basic['basicid']}" class="thumbnail ajax">
						<img src="{x2;v:basic['basicthumb']}" alt="" width="180" style="height: 140px;">
					</a>
