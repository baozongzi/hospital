...

{
	...
	public function getCourseList($args,$page,$number = 20,$order = 'cssequence ASC,cstime DESC,csid DESC')
	...
	{
		$sql = 'INSERT INTO x2_coursesubject (cstitle,cscatid,csuserid,csbasicid,cssubjectid,cstime,csthumb,cssequence,csdescribe) VALUES ("'.$args["cstitle"].'","'.$args["cscatid"].'","'.$args["csuserid"].'","'.$args["csbasicid"].'","'.$args["cssubjectid"].'","'.$args["cstime"].'","'.$args["csthumb"].'","'.$args["cssequence"].'","'.$args["csdescribe"].'")';

		return $this->db->mycount($sql);
