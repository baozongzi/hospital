				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					...
					<form action="index.php?course-master-course-edit" method="post" class="form-horizontal">
				        ...
				        <!-- <div class="form-group">
				            ...
				            <div class="col-sm-9">
							    <textarea id="contentdescribe" name="args[csdescribe]" class="form-control" rows="4">{x2;realhtml:nl2br($course['csdescribe'])}</textarea>
					        </div>
				        </div> -->
				        <div class="form-group">
				            <label for="coursetext" class="control-label col-sm-2">简介：</label>
				            <div class="col-sm-9">
							    <textarea id="coursetext" rows="7" cols="4" class="ckeditor" name="args[csdescribe]">{x2;realhtml:$course['csdescribe']}</textarea>
					        </div>
				        </div>
				       <!--  <div class="form-group">
