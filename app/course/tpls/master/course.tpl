							...
							<table class="table table-hover table-bordered">
					            ...
					            <tbody>
					            	...
					            	<tr>
					                    ...
					                    <td class="picture" style="line-height: 60px;"><img src="{x2;if:v:course['csthumb']}{x2;v:course['csthumb']}{x2;else}app/core/styles/images/noupload.gif{x2;endif}" alt="" style="width:60px;"/></td>
					                    <td>
					                        {x2;v:course['cstitle']}
					                    </td>
					                    <td>
