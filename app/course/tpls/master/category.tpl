							...
							<table class="table table-hover table-bordered">
								...
								<tbody>
									...
									<tr>
										...
										<td style="width: 360px;"><a onclick="javascript:openmenu(this);" href="javascript:void(0);" class="icon-plus-sign catool" rel="{x2;v:category['catid']}" data="0" app="{x2;$_app}"></a><span>{x2;v:category['catname']}</span></td>
										<td>
											<div class="btn-group">
											<a class="btn" href="index.php?{x2;$_app}-master-category&parent={x2;v:category['catid']}"><em class="glyphicon glyphicon-th-list"></em></a>
												...
												<a class="btn" href="javascript:if(confirm('确实要删除吗?'))location='index.php?{x2;$_app}-master-category-del&catid={x2;v:category['catid']}&page={x2;$page}{x2;$u}'"><em class="glyphicon glyphicon-remove"></em></a>
											</div>
										</td>
									</tr>
									{x2;endtree}
