		...
		<div class="main">
			...
			<div class="box itembox" style="padding-top:20px;">
				...
				<div class="col-xs-9">
					...
					<p><a href="index.php?course-app-course&csid={x2;v:content['csid']}"><?php echo nl2br($content['csdescribe']);?></a></p>
					<hr/>
					<p>
						<span class="pull-right">
							<a href="index.php?course-app-course&csid={x2;v:content['csid']}"><span class="glyphicon glyphicon-time"></span> <span>{x2;date:v:content['cstime'],'Y-m-d H:i:s'}</span></a>&nbsp;&nbsp;
							<a href="index.php?course-app-course&csid={x2;v:content['csid']}"><span class="glyphicon glyphicon-heart"></span> <span>{x2;v:content['click']}</span></a>
						</span>
					</p>
				</div>
			</div>
