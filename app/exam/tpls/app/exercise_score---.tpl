			...
			<div class="box itembox">
				...
				<div class="col-xs-4">
            		<div class="boardscore">
            			<h1 class="text-center text-danger">{x2;eval: echo number_format($allscore,2)} 分</h1>
            			<p>分数评价</p>
            		</div>
            	</div>
            	<div class="col-xs-8">
            		<div><b class="text-info">考试详情：</b></div>
                      ...
                      <tr>
                        ...
                        <td>100</td>
                        <!-- <td>{x2;eval: echo number_format($score[v:key] * 10,1)}</td> -->
                        <!-- <td>{x2;$sessionvars['examsessionscore']}</td> -->
                        <td>{x2;eval: echo number_format($average * $right[v:key],2)}</td>
                      </tr>
                      {x2;endif}
                      {x2;endtree}
                      <tr>
                        <td colspan="5" align="left">本次考试共<b class="text-warning">{x2;$allnumber}</b>道题，总分<b class="text-warning"><!-- {x2;$sessionvars['examsessionsetting']['examsetting']['score']} -->100</b>分，您做对<b class="text-warning">{x2;$allright}</b>道题，得到<b class="text-warning">{x2;eval: echo number_format($allscore,2)}</b>分</td>
                      </tr>
                   </table>
