			...
			<div class="box itembox">
            	...
            	<div class="col-xs-8">
            		<div><b class="text-info">考试详情：</b></div>
                      ...
                      {x2;endtree}
                      <tr>
                        <td colspan="5" align="left">本次考试共<b class="text-warning">{x2;$allnumber}</b>道题，总分<b class="text-warning"><!-- {x2;$sessionvars['examsessionsetting']['examsetting']['score']} -->{x2;$allscore}</b>分，您做对<b class="text-warning">{x2;$allright}</b>道题，得到<b class="text-warning">{x2;$sessionvars['examsessionscore']}</b>分</td>
                      </tr>
                   </table>
