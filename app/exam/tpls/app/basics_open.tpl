		...
		<div class="main box itembox">
			...
			<div class="col-xs-12" style="padding-left:0px;">
				...
				<div class="col-xs-3" style="width:20%">
					...
					{x2;if:v:basic['basicdemo'] == 1}
					<a href="index.php?exam-app-index-setCurrentBasic&basicid={x2;v:basic['basicid']}" target="_self" class="thumbnail ajax" style="position:relative;">
					...
					{x2;endif}
						...
						{x2;endif}
						<img src="{x2;if:v:basic['basicthumb']}{x2;v:basic['basicthumb']}{x2;else}app/core/styles/img/item.jpg{x2;endif}" alt="" width="100%" style="height: 140px;">
					</a>
