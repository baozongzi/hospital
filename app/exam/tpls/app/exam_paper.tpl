			...
			<div class="col-xs-3" id="questionbar">
				<dl class="clear" style="width:270px;" data-spy="affix" data-offset-top="235" id="questionindex">
					...
					<ul class="nav nav-tabs" role="tablist">
						...
						{x2;endif}
						{x2;eval: v:oid++}
						<li role="presentation" class="tabss presentation_{x2;v:quest} {x2;if:v:qid == 1} active {x2;endif}"><a href="#qt_{x2;v:quest}" aria-controls="home" role="tab" data-toggle="tab">{x2;$ols[v:oid]}</a></li>
						{x2;endif}
						{x2;endif}
						{x2;endtree}
					</ul>
