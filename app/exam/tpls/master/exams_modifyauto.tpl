					    ...
					    <div id="modeplane">
							...
							<div class="form-group questpanel panel_{x2;v:questype['questid']}">
								...
								<div class="col-sm-9 form-inline">
									...
									<span class="info">&nbsp;分，描述&nbsp;</span><input class="form-control" type="text" name="args[examsetting][questype][{x2;v:key}][describe]" value="{x2;$exam['examsetting']['questype'][v:key]['describe']}" size="10"/>
								</div>
							</div>
							<div class="form-group questpanel panel_{x2;v:questype['questid']}">
