...
class app
{
	...
	public function __construct(&$G)
	{
		...
		$feebasics = $this->db->mycount('select basicthumb,basicid,basic,basicareaid,obbasicid from x2_openbasics as o join x2_basic as b where o.obbasicid = b.basicid and obuserid = '.$this->_user['sessionuserid']);
		foreach ($feebasics as $key => $value) {
			$this->data['openbasics'][$value['basicid']] = $value;
		}
		// echo "<pre>";
		// print_r($this->_user);
		// print_r($this->data['openbasics']);
		// die;
